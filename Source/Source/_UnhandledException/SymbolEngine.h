...
scope, so I didn뭪 wrap them with this class.
...
// I didn뭪 wrap IMAGEHLP_SYMBOL because that is a variable-size
// structure.
...
public      :
                              ...
                              OUT PIMAGEHLP_LINE Line             )
    {
        ...
        // a zero displacement. I뭠l walk backward 100 bytes to
...
protected   :
    ...
    // symbol engine. This value doesn뭪 have to be an actual
